...
?>
    <main>
        ...
        <section class="content-container">
            <div class="row">
                <div class="col-md-6">
                    <img src="images/we-move-and-clean-storage.jpg" class="img-responsive"
                         alt="We Move & Clean - Storage">
                </div>
                <div class="col-md-6 one-line-padding">
                    <p><strong>Storage will be coming soon</strong>
                    </p>
                    <div class="row">
                        <!--                        <div class="col-xs-6">-->
                        <!---->
                        ...
                        <div class="col-xs-6">
                            <div class="contact-btn">
                                <a href="#why-us-collapse" class="btn" data-toggle="collapse">Why Us?</a>
                            </div>
                        </div>
        ...
        <section class="content-container collapse" id="why-us-collapse">
            <div class="row">
                <div class="col-md-8">
                    <p>
                    ...
                    <p>
                        ...
                        We’ve got more than a decade of combined experience in the Carpet Cleaning Industry. What’s
                        more, your property and your belongings are covered by ‘Public
                    ...
                    <p>
                        ...
                        We use specialised equipment (like deep steam carpet cleaning equipment etc.) which allows
                        removes 99.99% of bacteria, viruses and dirt. Our staff are
                    ...
                    <p>
                        ...
                        If you wish to add ‘<a href="services-cleaning.php">Cleaning</a>’ or ‘<a href="services-clearance.php">Clearance</a>’ service to your ‘<a href="services-carpet-cleaning.php">Carpet Cleaning</a>’ you’ll save time
                        by contacting only one company. You’ll save money due to
                    ...
                    <p>
                        ...
                        You’re always in control so it’s up to you if you’d like to have the whole property cleaned or
                        only one room.
                    </p>
                    <p align="center">
